...
async function startWorkspace(){
  ...
  try{await initializeWorkspace();overlay.hidden=true;workspace.inert=false;workspace.setAttribute('aria-busy','false');}
